 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://soap.webservices", wsdlLocation = "http://localhost:8080/services/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://soap.webservices/", "CalculatorService");
    ...
    public Calculator getCalculator() {
        return super.getPort(new QName("http://soap.webservices/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculator(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.webservices", "Calculator"), Calculator.class, features);
    }
